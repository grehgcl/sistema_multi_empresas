...
async function fixAllColumns() {
    try {
        ...
        try {
            ...
            console.log('?? Erro ao adicionar telefone:', e.message);
        }
        ...
        try {
            ...
            console.log('?? Erro ao adicionar agendamentos_mes:', e.message);
        }
        ...
        try {
            ...
            console.log('?? Erro ao adicionar mes_referencia:', e.message);
        }
        ...
        try {
            ...
            console.log('?? Erro ao adicionar lembrete_enviado:', e.message);
        }
        ...
        try {
            ...
            console.log('?? Erro ao adicionar dias_bloqueio:', e.message);
        }
