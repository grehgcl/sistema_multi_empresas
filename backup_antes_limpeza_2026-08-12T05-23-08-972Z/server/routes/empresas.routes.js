...
// ============================================
// GET /api/empresa/dados - CORRIGIDA
// ============================================
router.get('/dados', auth, (req, res) => {
    try {
        ...
        // 🔥 USAR centralDb (banco central)
        const sql = `SELECT id, nome, plano, limite_profissionais, trial_expira, 
        ...
        centralDb.get(sql, [empresaId], (err, empresa) => {
            if (err) {
